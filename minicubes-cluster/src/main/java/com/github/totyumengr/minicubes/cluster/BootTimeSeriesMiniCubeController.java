...
public class BootTimeSeriesMiniCubeController {
    ...
    public @ResponseBody
    String mode(@NotBlank @RequestParam String timeSeries, @NotBlank @RequestParam boolean mode) {
    ...
    public @ResponseBody
    String reassign(@NotBlank @RequestParam String cubeId,
    ...
    public @ResponseBody
    String merge(@NotBlank @RequestParam int version,
                 @NotBlank @RequestParam String timeSeries) {
    ...
    public @ResponseBody
    BigDecimal sum(@NotBlank @RequestParam String indName,
    ...
    public @ResponseBody
    Map<Integer, BigDecimal> groupsum(@NotBlank @RequestParam String indName,
                                      @RequestParam(required = false) String filterDims,
    ...
    public @ResponseBody
    Long count(@NotBlank @RequestParam String indName,
               @RequestParam(required = false) String filterDims,
               @NotBlank @RequestParam String... timeSeries) throws Throwable {
    ...
    public @ResponseBody
    Map<Integer, Long> groupcount(@NotBlank @RequestParam String indName,
                                  @RequestParam(required = false) String filterDims,
                                  @RequestParam String groupbyDim,
                                  @NotBlank @RequestParam String... timeSeries) throws Throwable {
    ...
    public @ResponseBody
    Map<Integer, Set<Integer>> distinct(@NotBlank @RequestParam String indName,
    ...
    public @ResponseBody
    Map<Integer, Integer> distinctCount(@NotBlank @RequestParam String indName,
                                        @NotBlank @RequestParam(required = false) Boolean isDim,
                                        @RequestParam(required = false) String filterDims,
                                        @RequestParam String groupbyDim,
                                        @NotBlank @RequestParam String... timeSeries) throws Throwable {
